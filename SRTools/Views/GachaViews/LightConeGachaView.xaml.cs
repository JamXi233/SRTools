...
namespace SRTools.Views.GachaViews
{
    public sealed partial class LightConeGachaView : Page
    {
        ...
        public LightConeGachaView()
        {
            ...
            selectedCardPool = new GachaModel.CardPoolInfo { FiveStarPity = 80, FourStarPity = 10 }; // 替换成实际获取卡池信息的逻辑
            LoadData();
        }
        ...
        private async void LoadData()
        {
            ...
            var settingsFile = await srtoolsFolder.GetFileAsync("GachaRecords_LightCone.ini");
