...
{
    public sealed partial class NewbieGachaView : Page
    {

        public NewbieGachaView()
        {
            this.InitializeComponent();
            Logging.Write("Switch to NewbieGachaView", 0);
            LoadData();
        }
        ...
        private async void LoadData()
        {
            ...
            var settingsFile = srtoolsFolder.GetFileAsync("GachaRecords_Newbie.ini").AsTask().GetAwaiter().GetResult();
